...
public:
	...
	enum class GBUFFER_DEPTH_TYPE { GBUFFER_DEPTH_TYPE_STENCIL };
	...
	void SetDepthAttachment(GBUFFER_DEPTH_TYPE type, const unsigned int width, const unsigned int height);
