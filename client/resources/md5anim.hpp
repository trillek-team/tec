...
namespace tec {
	...
	public:
		 ...
		 * resource. \param[in] std::shared_ptr<MD5Mesh> mesh The mesh file this animation will be
		 * animating. \return std::shared_ptr<MD5Anim> The create MD5Anim resource.
		 */
		static std::shared_ptr<MD5Anim> Create(
			const FilePath& fname, std::shared_ptr<MD5Mesh> mesh);
