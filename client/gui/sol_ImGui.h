...
// Source https://github.com/MSeys/sol2_ImGui_Bindings/blob/master/LICENSE

#pragma once
#include <imgui.h> // Modified from original to point at header locations relative to project
#include <string>
#include <sol/sol.hpp> // Modified from original to point at header locations relative to project
