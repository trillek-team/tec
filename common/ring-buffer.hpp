...
public:
	...
	*/
	T& back() { return buffer[read]; }
	/** 
	* Returns the last element on the container (ie, the most older)
	*/
	const T& back() const { return buffer[read]; }
	...
	*/
	bool empty() const { return this->elements == 0; }

	/**
	* Returns true if there is not any element stored
	*/
	bool full() const { return this->elements == N; }

	/**
	* Returns the number of items stored
	*/
	std::size_t size() const { return this->elements; }
